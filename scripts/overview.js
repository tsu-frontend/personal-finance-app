...
//     currentSpent: 338.0,
//     categories: [
//       { name: "Entertainment", amount: 50.0, color: "#626070" },
//       { name: "Bills", amount: 750.0, color: "#82C9D7" },
//       { name: "Dining Out", amount: 75.0, color: "#F2CDAC" },
//       { name: "Personal Care", amount: 100.0, color: "#277C78" },
//     ],
//   },

//   transactions: [
//     { id: 1, name: "Emma Richardson", amount: 75.5, type: "income", date: "2024-08-20", icon: "profile-emma.jpg" },
//     { id: 2, name: "Savory Bites Bistro", amount: 55.5, type: "expense", date: "2024-08-19", icon: "bread-icon.svg", iconBg: "#F8F4F0" },
//     { id: 3, name: "Daniel Carter", amount: 42.3, type: "expense", date: "2024-08-18", icon: "profile-daniel.jpg" },
//     { id: 4, name: "Sun Park", amount: 120.0, type: "income", date: "2024-08-17", icon: "profile-sun.jpg" },
//     { id: 5, name: "Urban Service Hub", amount: 65.0, type: "expense", date: "2024-08-17", icon: "building-icon.svg", iconBg: "#F2CDAC" },
//   ],
...
const getData = async () => {
  ...
  budgetsData.forEach((object) => {
    ...
    console.log(spentArr, colorsArr);
