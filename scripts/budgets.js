...
class BudgetPage {
    ...
    addLastSpendings(trsInfo) {
        ...
        document.querySelectorAll('[data-name="parent_spendings"]').forEach((parent) => {
            var _a, _b;
            const budgetCategory = (_b = (_a = parent
                .closest('[data-name="budget"]')) === null || _a === void 0 ? void 0 : _a.querySelector("h5")) === null || _b === void 0 ? void 0 : _b.textContent;
            if (!budgetCategory || !grouped[budgetCategory])
                return;
