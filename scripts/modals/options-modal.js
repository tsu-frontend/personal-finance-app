...
class OptionsModal {
    static open(data, modalId, btn) {
        ...
        btn.insertAdjacentHTML("beforeend", `<div id="options-modal" class="animate-open hover:cursor-default flex absolute right-0 top-[36px] w-[114px] bg-[#FFF] py-[12px] px-[20px] rounded-[8px] flex-col gap-[12px] shadow-[0px_4px_24px_0px_rgba(0,0,0,0.25)]">
