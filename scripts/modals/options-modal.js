...
class OptionsModal {
    static open(data, modalId, btn, pageType) {
        ...
        <button id="edit-button" class="hover:cursor-pointer text-[#201F24] text-[14px] font-[Public Sans] font-normal leading-[100%]">Edit ${pageType}</button>
        <div class="w-full h-[1px] bg-[#F2F2F2]"></div>
        <button id="delete-button" class="hover:cursor-pointer text-[#C94736] text-[14px] font-[Public Sans] font-normal leading-[100%]">Delete ${pageType}</button>
      </div>`);
