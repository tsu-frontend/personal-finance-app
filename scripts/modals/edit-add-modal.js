...
class EditAddModal {
    static open(modalType, data, modalId = null) {
        ...
        document.body.insertAdjacentHTML("beforeend", `<div id="edit-add-modal" class="animate-fade-in z-2 fixed inset-0 bg-[rgb(0,0,0,0.5)] flex justify-center items-center">
