...
class ThemeModal {
  static open(chosenTheme: string, data: any[], setChosenTheme: (theme: string) => void): void {
    ...
    const themeModal = document.querySelector("#theme-modal-wrapper") as HTMLElement;
