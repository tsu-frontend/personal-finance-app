...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.body.insertAdjacentHTML(
    "afterbegin",
    `
      <nav class="select-none overflow-hidden z-1 h-[52px] w-[100vw] bg-[#201F24] rounded-tr-[8px] rounded-tl-[8px] pt-[8px] px-[16px] bottom-0 fixed flex flex-col md:h-[74px] md:px-[40px] xl:static xl:h-auto xl:w-[min(20.83%,300px)] xl:gap-[24px] xl:px-0 xl:pr-[24px] xl:rounded-tl-[0] xl:rounded-tr-[16px] xl:rounded-br-[16px] shrink-0 transition-all duration-300 ease">
        <svg id="nav-logo" xmlns="http://www.w3.org/2000/svg" width="122" height="22" viewBox="0 0 122 22" fill="none" class="hidden text-[#FFFFFF] h-[101.76px] ml-[32px] xl:block">
          <path data-id="logo-letter" class="animate-letters transition-all duration-300 ease" d="M8.192 21.44H2.176V10.24H0V5.312H2.304C2.944 2.272 5.92 0 11.2 0H12.48V4.288H10.24C8.576 4.288 7.776 4.448 7.808 5.312H12.48V10.24H8.192V21.44Z" fill="white" />
        ...
        <div class="flex-1 w-[100%] flex justify-between items-center md:gap-[42px] xl:flex-col xl:items-start xl:justify-start xl:gap-[4px]">
          ...
          <div id="nav-minimize-button" class="hover:cursor-pointer group hidden w-[100%] h-[56px] gap-[16px] xl:flex mt-[calc(100vh-490px-24px)] items-center pl-[33.5px]">
            <svg class="transition-all duration-300 ease pop-icons" fill="none" height="20" viewBox="0 0 20 20" width="20" xmlns="http://www.w3.org/2000/svg">
            ...
            <p class="animate-top xl:group-hover:text-[#F2F2F2] transition-all duration-300 ease hidden text-[12px] font-[700] leading-[18px] text-[#B3B3B3] xl:block">Minimize Menu</p>
          </div>
        </div>
      </nav>
    `
...
function createNavAnchor(page) {
  ...
  let iconHtml = icon;
  if (isActive) {
    iconHtml = iconHtml.replace('fill="#b3b3b3"', 'fill="#277C78"').replace('class="xl:group-hover:fill-[#F2F2F2] transition-all duration-300 ease"', "transition-all duration-300 ease");
  }
  const labelClass = isActive ? "animate-left hidden text-[12px] font-[700] leading-[18px] text-[#201F24] md:block" : "animate-left xl:group-hover:text-[#F2F2F2] transition-all duration-300 ease hidden text-[12px] font-[700] leading-[18px] text-[#B3B3B3] md:block";
  return `
